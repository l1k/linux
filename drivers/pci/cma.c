...
/*
 * Component Measurement and Authentication (CMA-SPDM, PCIe r7.0 sec 6.31)
 *
 * Copyright (C) 2021 Huawei
 *     Jonathan Cameron <Jonathan.Cameron@huawei.com>
 *
 * Copyright (C) 2022-26 Intel Corporation
 */
...
/*
 * spdm_validate_cert_chain() calls pci_cma_validate() to check requirements
